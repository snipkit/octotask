...
const storedProfile = typeof window !== 'undefined' ? localStorage.getItem('octotask_profile') : null;
...
export const updateProfile = (updates: Partial<Profile>) => {
  ...
  if (typeof window !== 'undefined') {
    localStorage.setItem('octotask_profile', JSON.stringify(profileStore.get()));
  }
};

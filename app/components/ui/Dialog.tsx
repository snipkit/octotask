  ...
  return (
    <RadixDialog.Title
      className={classNames(
        'text-lg font-medium text-octotask-elements-textPrimary',
          ...
          <div className="flex flex-col">
            ...
            {showCloseButton && (
              <RadixDialog.Close asChild onClick={onClose}>
                <IconButton
                  icon="i-ph:x"
                  className="absolute top-3 right-3 text-octotask-elements-textSecondary hover:text-octotask-elements-textPrimary"
                />
              </RadixDialog.Close>
            )}
          </div>

...
export default function DataTab() {
  ...
  const handleExportSettings = () => {
    const settings = {
      ...
      octotask_theme: localStorage.getItem('octotask_theme'),
    };

    downloadAsJson(settings, 'octotask-settings.json');
  ...
  const processChatData = (
    ...
    // Handle Octotask standard format (single chat)
    ...
    // Handle Octotask export format (multiple chats)
  ...
  return (
    <div className="p-4 bg-octotask-elements-bg-depth-2 border border-octotask-elements-borderColor rounded-lg mb-4">
      <div className="mb-6">
        <h3 className="text-lg font-medium text-octotask-elements-textPrimary mb-4">Data Management</h3>
        <div className="space-y-8">
          <div className="flex flex-col gap-4">
            <div>
              <h4 className="text-octotask-elements-textPrimary mb-2">Chat History</h4>
              ...
              <div className="flex gap-4">
                <button
                  ...
                  className="px-4 py-2 bg-octotask-elements-button-primary-background hover:bg-octotask-elements-button-primary-backgroundHover text-octotask-elements-textPrimary rounded-lg transition-colors"
                >
                  Export All Chats
                </button>
                <button
                ...
                <button
                  ...
                  className={classNames(
                    'px-4 py-2 bg-octotask-elements-button-danger-background hover:bg-octotask-elements-button-danger-backgroundHover text-octotask-elements-button-danger-text rounded-lg transition-colors',
            ...
            <div>
              <h4 className="text-octotask-elements-textPrimary mb-2">Settings Backup</h4>
              <p className="text-sm text-octotask-elements-textSecondary mb-4">
              ...
              <div className="flex gap-4">
                ...
                <label className="px-4 py-2 bg-octotask-elements-button-primary-background hover:bg-octotask-elements-button-primary-backgroundHover text-octotask-elements-textPrimary rounded-lg transition-colors cursor-pointer">
                  Import Settings
            ...
            <div>
              <h4 className="text-octotask-elements-textPrimary mb-2">API Keys Management</h4>
              <p className="text-sm text-octotask-elements-textSecondary mb-4">

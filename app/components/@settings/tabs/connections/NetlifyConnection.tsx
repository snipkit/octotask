      ...
      <div className="p-6 space-y-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            />
            <h3 className="text-base font-medium text-octotask-elements-textPrimary">Netlify Connection</h3>
          </div>
        </div>
        ...
        {!connection.user ? (
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-4 p-4 bg-[#F8F8F8] dark:bg-[#1A1A1A] rounded-lg">
              ...
              />
              <div>
                <h4 className="text-sm font-medium text-octotask-elements-textPrimary">{connection.user.full_name}</h4>
                <p className="text-sm text-octotask-elements-textSecondary">{connection.user.email}</p>
              </div>
            </div>

                  ...
                  <div className="space-y-4 mb-4">
                    <div className="flex gap-2">
                      <input
                        ...
                        className="flex-1 px-4 py-2 rounded-lg bg-[#F5F5F5] dark:bg-[#252525] border border-[#E5E5E5] dark:border-[#333333] text-octotask-elements-textPrimary"
                      />
                      <button
                        onClick={() => setFilters({})}
                        className="px-3 py-2 rounded-lg bg-[#F5F5F5] dark:bg-[#252525] text-octotask-elements-textSecondary hover:text-octotask-elements-textPrimary"
                      >
                  ...
                  {selectedRepository ? (
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2">
                        <label className="text-sm text-octotask-elements-textSecondary">Select Branch</label>
                        <select
                          value={selectedBranch}
                          onChange={(e) => setSelectedBranch(e.target.value)}
                          className="w-full px-3 py-2 rounded-lg bg-octotask-elements-background-depth-2 dark:bg-octotask-elements-background-depth-3 border border-octotask-elements-borderColor dark:border-octotask-elements-borderColor-dark text-octotask-elements-textPrimary dark:text-octotask-elements-textPrimary-dark focus:outline-none focus:ring-2 focus:ring-octotask-elements-borderColor dark:focus:ring-octotask-elements-borderColor-dark"
                        >
                          {branches.map((branch) => (
                            <option
                              key={branch.name}
                              value={branch.name}
                              className="bg-octotask-elements-background-depth-2 dark:bg-octotask-elements-background-depth-3 text-octotask-elements-textPrimary dark:text-octotask-elements-textPrimary-dark"
                            >
    ...
    <button
      ...
      className={classNames(
        ...
        active
          ...
          : 'bg-[#F5F5F5] dark:bg-[#252525] text-octotask-elements-textPrimary dark:text-white hover:bg-[#E5E5E5] dark:hover:bg-[#333333] border border-[#E5E5E5] dark:border-[#333333]',
      )}
    >
      {children}
    </button>
...
function RepositoryList({
  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center py-8 text-octotask-elements-textSecondary">
  ...
  if (repos.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-8 text-octotask-elements-textSecondary">
  ...
  return (
    <div className="p-4 rounded-lg bg-[#F5F5F5] dark:bg-[#252525] border border-[#E5E5E5] dark:border-[#333333] hover:border-purple-500/50 transition-colors">
      <div className="flex items-center justify-between mb-2">
        <div className="flex items-center gap-2">
          <span className="i-ph:git-repository text-octotask-elements-textTertiary" />
          <h3 className="font-medium text-octotask-elements-textPrimary dark:text-white">{repo.name}</h3>
        </div>
        <button
          onClick={onSelect}
      ...
      {repo.description && <p className="text-sm text-octotask-elements-textSecondary mb-3">{repo.description}</p>}
      <div className="flex items-center gap-4 text-sm text-octotask-elements-textTertiary">
        {repo.language && (

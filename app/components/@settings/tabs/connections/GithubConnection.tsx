    ...
    >
      <div className="p-6 space-y-6">
        <div className="flex items-center gap-2">
          <div className="i-ph:github-logo w-5 h-5 text-octotask-elements-textPrimary" />
          <h3 className="text-base font-medium text-octotask-elements-textPrimary">GitHub Connection</h3>
        </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between">
                    <h3 className="text-lg font-medium text-octotask-elements-textPrimary">
                      {connection.user.name || connection.user.login}
                    </h3>
                    <div
                      className={classNames(
                        'i-ph:caret-down w-4 h-4 text-octotask-elements-textSecondary transition-transform',
                        isStatsExpanded ? 'rotate-180' : '',
                      )}
                    />
                  </div>
                  {connection.user.bio && (
                    <p className="text-sm text-start text-octotask-elements-textSecondary">{connection.user.bio}</p>
                  )}
                  <div className="flex gap-4 mt-2 text-sm text-octotask-elements-textSecondary">
            ...
            {isStatsExpanded && (
              <div className="pt-4">
                {connection.stats.organizations.length > 0 && (
                  <div className="mb-6">
                    <h4 className="text-sm font-medium text-octotask-elements-textPrimary mb-3">Organizations</h4>
                    <div className="flex flex-wrap gap-3">
                      {connection.stats.organizations.map((org) => (
                        ...
                        >
                          ...
                          <span className="text-sm text-octotask-elements-textPrimary">{org.login}</span>
                        </a>
                      ))}
                    </div>
                  </div>
                ...
                <div className="mb-6">
                  <h4 className="text-sm font-medium text-octotask-elements-textPrimary mb-3">Recent Activity</h4>
                  <div className="space-y-3">
                    {connection.stats.recentActivity.map((event) => (
                      <div key={event.id} className="p-3 rounded-lg bg-[#F8F8F8] dark:bg-[#1A1A1A] text-sm">
                        <div className="flex items-center gap-2 text-octotask-elements-textPrimary">
                          <div className="i-ph:git-commit w-4 h-4 text-octotask-elements-textSecondary" />
                        ...
                        <div className="mt-1 text-xs text-octotask-elements-textSecondary">
                ...
                <div className="grid grid-cols-4 gap-4 mb-6">
                  <div className="p-4 rounded-lg bg-[#F8F8F8] dark:bg-[#1A1A1A]">
                    <div className="text-sm text-octotask-elements-textSecondary">Member Since</div>
                    <div className="text-lg font-medium text-octotask-elements-textPrimary">
                      {new Date(connection.user.created_at).toLocaleDateString()}
                    </div>
                  </div>
                  <div className="p-4 rounded-lg bg-[#F8F8F8] dark:bg-[#1A1A1A]">
                    <div className="text-sm text-octotask-elements-textSecondary">Public Gists</div>
                    <div className="text-lg font-medium text-octotask-elements-textPrimary">
                      {connection.stats.totalGists}
                    </div>
                  </div>
                  <div className="p-4 rounded-lg bg-[#F8F8F8] dark:bg-[#1A1A1A]">
                    <div className="text-sm text-octotask-elements-textSecondary">Organizations</div>
                    <div className="text-lg font-medium text-octotask-elements-textPrimary">
                      {connection.stats.organizations.length}
                    </div>
                  </div>
                  <div className="p-4 rounded-lg bg-[#F8F8F8] dark:bg-[#1A1A1A]">
                    <div className="text-sm text-octotask-elements-textSecondary">Languages</div>
                    <div className="text-lg font-medium text-octotask-elements-textPrimary">
                ...
                <h4 className="text-sm font-medium text-octotask-elements-textPrimary mb-3">Recent Repositories</h4>
                <div className="space-y-3">
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          <h5 className="text-sm font-medium text-octotask-elements-textPrimary flex items-center gap-2">
                            <div className="i-ph:git-repository w-4 h-4 text-octotask-elements-textSecondary" />
                            {repo.name}
                          </h5>
                          {repo.description && (
                            <p className="text-xs text-octotask-elements-textSecondary mt-1">{repo.description}</p>
                          )}

  ...
  ({
    ...
    return (
      <div className="relative z-port-dropdown" ref={dropdownRef}>
        ...
        {isDropdownOpen && (
          <div className="absolute right-0 mt-2 bg-octotask-elements-background-depth-2 border border-octotask-elements-borderColor rounded shadow-sm min-w-[140px] dropdown-animation">

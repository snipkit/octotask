          ...
          >
            ...
            >
              {modelLoading === 'all' || modelLoading === provider?.name ? (
                <div className="px-3 py-2 text-sm text-octotask-elements-textTertiary">Loading...</div>
              ) : filteredModels.length === 0 ? (
                <div className="px-3 py-2 text-sm text-octotask-elements-textTertiary">No models found</div>
              ) : (
                  ...
                  <div
                    ...
                    className={classNames(
                      ...
                      model === modelOption.name || focusedIndex === index
                        ...
                        : undefined,
                      focusedIndex === index ? 'ring-1 ring-inset ring-octotask-elements-focus' : undefined,
                    )}
                    onClick={(e) => {
                      e.stopPropagation();

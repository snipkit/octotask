              ...
              >
                ...
                <div
                  className={classNames(
                    'relative bg-octotask-elements-background-depth-2 p-3 rounded-lg border border-octotask-elements-borderColor relative w-full max-w-chat mx-auto z-prompt',
                    ...
                    <div className="flex justify-between items-center text-sm p-4 pt-2">
                      ...
                      {input.length > 3 ? (
                        <div className="text-xs text-octotask-elements-textTertiary">
                          Use{' '}
                          <kbd className="kdb px-1.5 py-0.5 rounded bg-octotask-elements-background-depth-2">Shift</kbd>{' '}
                          +{' '}
                          <kbd className="kdb px-1.5 py-0.5 rounded bg-octotask-elements-background-depth-2">
                            Return
                          </kbd>{' '}
                          a new line
                        </div>
...
function ScrollToBottom() {
  ...
  return (
    !isAtBottom && (
      <button
        className="absolute z-50 top-[0%] translate-y-[-100%] text-4xl rounded-lg left-[50%] translate-x-[-50%] px-1.5 py-0.5 flex items-center gap-2 bg-octotask-elements-background-depth-3 border border-octotask-elements-borderColor text-octotask-elements-textPrimary text-sm"

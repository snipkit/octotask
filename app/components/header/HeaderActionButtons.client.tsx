  ...
  return (
    <div className="flex">
      <div className="relative" ref={dropdownRef}>
        <div className="flex border border-octotask-elements-borderColor rounded-md overflow-hidden mr-2 text-sm">
          <Button
            ...
            className="px-4 hover:bg-octotask-elements-item-backgroundActive flex items-center gap-2"
          >
        ...
        {isDropdownOpen && (
          <div className="absolute right-2 flex flex-col gap-1 z-50 p-1 mt-1 min-w-[13.5rem] bg-octotask-elements-background-depth-2 rounded-md shadow-lg bg-octotask-elements-backgroundDefault border border-octotask-elements-borderColor">
            <Button
              active
              onClick={() => {
                handleDeploy();
              ...
              className="flex items-center w-full px-4 py-2 text-sm text-octotask-elements-textPrimary hover:bg-octotask-elements-item-backgroundActive gap-2 rounded-md group relative"
            >
              <img
                className="w-5 h-5"
                height="24"
            ...
            <Button
              active={false}
              disabled
              className="flex items-center w-full rounded-md px-4 py-2 text-sm text-octotask-elements-textTertiary gap-2"
            >
      ...
      <div className="flex border border-octotask-elements-borderColor rounded-md overflow-hidden">
        ...
        >
          <div className="i-octotask:chat text-sm" />
        </Button>
        <div className="w-[1px] bg-octotask-elements-borderColor" />
        <Button
      ...
      className={classNames(
        'flex items-center p-1.5',
        {
          'bg-octotask-elements-item-backgroundDefault hover:bg-octotask-elements-item-backgroundActive text-octotask-elements-textTertiary hover:text-octotask-elements-textPrimary':
            !active,
          'bg-octotask-elements-item-backgroundAccent text-octotask-elements-item-contentAccent': active && !disabled,
